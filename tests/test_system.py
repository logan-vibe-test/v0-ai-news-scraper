...
class SystemTester:
    ...
    async def test_content_processing(self):
        ...
        try:
            ...
            import ai_voice_scraper.processors.content_processor as cp
    ...
    async def run_all_tests(self):
        ...
        if passed == total:
            ...
            logger.info("Run: ai-voice-scraper")
...
class TestAIVoiceScraper(unittest.TestCase):
    """Unit test class for AI Voice Scraper"""
    
    def test_system(self):
        """Run the system test"""
        tester = SystemTester()
        passed, total = asyncio.run(tester.run_all_tests())
        self.assertGreaterEqual(passed, 3, "At least core functionality should work")
